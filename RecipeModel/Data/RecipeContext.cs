...
namespace RecipeModel.Data
{
    public class RecipeContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FavouriteRecipe>().HasKey(table => new { table.Id, table.RecipeId, table.UserId });
            modelBuilder.Entity<Image>().HasKey(table => new { table.Id, table.RecipeId, table.UserId });
            modelBuilder.Entity<RecipeIngredient>().HasKey(table => new { table.RecipeId, table.IngredientId });
            modelBuilder.Entity<Review>().HasKey(table => new { table.Id, table.UserId, table.RecipeId });
        }
