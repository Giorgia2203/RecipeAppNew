        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BakingTime = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandIngredient", x => new { x.BrandId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_BrandIngredient_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandIngredient_Ingredient_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteRecipe", x => new { x.Id, x.RecipeId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Image", x => new { x.Id, x.RecipeId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Review", x => new { x.Id, x.UserId, x.RecipeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandIngredient_IngredientId",
                table: "BrandIngredient",
                column: "IngredientId");
